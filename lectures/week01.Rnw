...
\centerline{\includegraphics{figures/allscalesorig}}

\column{0.1\textwidth}
\column{0.45\textwidth}

\centerline{\includegraphics{figures/allscaleslog}}
...
\centerline{\includegraphics{figures/heaps}}
...
\centerline{include_graphics[scale=0.3]{"pictures/fdp-en.png"}}
